...
('Benaissa', 'Mohammed', '2014-06-15', 'ELV2024001'),
('Zerrouki', 'Amina', '2013-09-22', 'ELV2024002'),
('Lahlou', 'Yacine', '2012-11-08', 'ELV2024003'),
('Brahimi', 'Khadija', '2011-04-12', 'ELV2024004'),
('Chouaib', 'Omar', '2010-12-03', 'ELV2024005');
...
-- =====================================================
INSERT INTO periode (libelle, date_debut, date_fin, ordre, active) VALUES
('1er Trimestre 2024-2025', '2024-09-01', '2024-12-20', 1, true),
('2ème Trimestre 2024-2025', '2025-01-08', '2025-03-28', 2, false),
('3ème Trimestre 2024-2025', '2025-04-15', '2025-06-30', 3, false);

-- =====================================================
-- 11. TYPES D'ÉVALUATION
-- =====================================================
INSERT INTO type_evaluation (code, libelle, description, coefficient_defaut, actif) VALUES
...
-- =====================================================
INSERT INTO evaluation (id_cours, id_periode, id_type_eval, intitule, date_evaluation, note_sur, coefficient, duree_minutes, commentaire, date_creation) VALUES
-- Évaluations pour CP-A
(1, 1, 1, 'Contrôle Alphabet Arabe', '2024-10-15', 20.0, 1.0, 30, 'Premier contrôle d''alphabet', '2024-10-10 10:00:00'),
(2, 1, 5, 'Récitation Sourate Al-Fatiha', '2024-10-20', 20.0, 2.0, 15, 'Récitation avec Tajwid', '2024-10-15 10:00:00'),
(3, 1, 1, 'Contrôle Additions', '2024-10-25', 20.0, 1.0, 45, 'Additions simples', '2024-10-20 10:00:00'),

-- Évaluations pour CE1-A
(4, 1, 1, 'Contrôle Grammaire Arabe', '2024-10-16', 20.0, 1.0, 45, 'Les pronoms personnels', '2024-10-11 10:00:00'),
(5, 1, 5, 'Récitation Sourate Al-Ikhlass', '2024-10-21', 20.0, 2.0, 10, 'Récitation parfaite exigée', '2024-10-16 10:00:00'),
(6, 1, 2, 'Devoir Tables de Multiplication', '2024-10-26', 20.0, 2.0, 60, 'Tables de 2 à 5', '2024-10-21 10:00:00'),

-- Évaluations pour 6EME-A
(7, 1, 2, 'Devoir Poésie Arabe', '2024-10-17', 20.0, 2.0, 90, 'Analyse de poème classique', '2024-10-12 10:00:00'),
(8, 1, 5, 'Récitation Sourate Yasin', '2024-10-22', 20.0, 2.0, 20, 'Récitation avec compréhension', '2024-10-17 10:00:00'),
(9, 1, 1, 'Contrôle Hadith', '2024-10-18', 20.0, 1.0, 45, 'Les 40 Hadiths - Partie 1', '2024-10-13 10:00:00'),

-- Évaluations pour 5EME-A
(10, 1, 3, 'Examen Fiqh', '2024-10-30', 20.0, 3.0, 120, 'La purification et la prière', '2024-10-25 10:00:00'),
(11, 1, 2, 'Devoir Mathématiques', '2024-10-28', 20.0, 2.0, 90, 'Fractions et décimaux', '2024-10-23 10:00:00');
...
-- 15. QUELQUES RETARDS
-- =====================================================
INSERT INTO retard (id_eleve, id_cours, date_retard, heure_arrivee, duree_minutes, justifie, motif, commentaire, date_saisie) VALUES
(2, 4, '2024-10-08', '08:15:00', 15, true, 'Transport en commun', 'Bus en retard', '2024-10-08 08:30:00'),
(3, 8, '2024-10-14', '09:20:00', 20, false, 'Réveil tardif', 'Pas d''excuse valable', '2024-10-14 09:30:00'),
(4, 11, '2024-10-22', '14:10:00', 10, true, 'Embouteillages', 'Circulation dense', '2024-10-22 14:15:00');
